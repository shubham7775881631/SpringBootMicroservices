...
public class EmployeeController {
	...
	@Autowired
	private InfyAllocationFeignClient infyAllocationFeignClient;
	
	@Autowired
	private InfyEmployeeFinanceFeignClient infyEmployeeFinanceFeignClient;
	...
	@HystrixCommand(fallbackMethod = "viewFullEmployeeProfileFallback", ignoreExceptions = IllegalStateException.class)
	public ResponseEntity<RestEmployeeDTO> viewFullEmployeeProfile(@PathVariable Integer employeeId) throws EmployeeException {
		
		System.out.println("======== Inside viewFullEmployeeProfile Method ======== ");
//		String allocationMsUrl = "http://InfyAllocation/manager/getEmployeeAndManager/"+employeeId;
		...
		RestEmployeeDTO restEmployeeDTO = infyAllocationFeignClient.getEmployeeAndManager(employeeId);
		System.out.println("This is the rest employee DTO "+restEmployeeDTO);
...
//		String financeMsUrl = "http://Infy-EmployeeFinance/finance/getFinance/"+employeeDTO.getFinanceId();
		...
		FinanceDTO financeDTO = infyEmployeeFinanceFeignClient.getEmployeeFinance(employeeDTO.getFinanceId());
	...
	public ResponseEntity<RestEmployeeDTO> viewFullEmployeeProfileFallback(Integer employeeId) throws  EmployeeException
	{
		System.out.println("======= Inside Fallback Method-InfyEmployee Microservice ==================");
		return new ResponseEntity<>(new RestEmployeeDTO(),HttpStatus.OK) ;
	}

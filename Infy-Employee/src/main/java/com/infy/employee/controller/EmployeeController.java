...
public class EmployeeController {
	...
	public ResponseEntity<RestEmployeeDTO> viewFullEmployeeProfile(@PathVariable Integer employeeId) throws EmployeeException {
		...
		String allocationMsUrl = "http://empribbon/manager/getEmployeeAndManager/"+employeeId;
		...
		String financeMsUrl = "http://empribbon/finance/getFinance/"+employeeDTO.getFinanceId();

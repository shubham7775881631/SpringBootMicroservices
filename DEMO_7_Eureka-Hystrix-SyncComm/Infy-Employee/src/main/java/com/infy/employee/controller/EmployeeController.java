...
import com.infy.employee.sevrice.impl.HystrixService;
...
public class EmployeeController {
	...
	public ResponseEntity<RestEmployeeDTO> viewFullEmployeeProfile(@PathVariable Integer employeeId) throws EmployeeException {
		...
		RestEmployeeDTO restEmployeeDTO = hystrixService.getEmployeeAndManager(employeeId);
		
		//fetching employee details from our current class details 
		EmployeeDTO employeeDTO = employeeService.viewEmployeeProfile(employeeId);
		
		//fetching the employee finance details from the MS-Infy-Finance
		FinanceDTO financeDTO = hystrixService.getFinanceDetails(employeeDTO.getFinanceId());

...
public class ExceptionControllerAdvice
{
    ...
    public ResponseEntity<ErrorInfo> meetingSchedulerExceptionHandler(EmployeeException exception)
    {
	...
	errorInfo.setErrorMessage(environment.getProperty("General.EXCEPTION_MESSAGE")+exception.getMessage());
